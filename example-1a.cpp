/*
please note that the series of optmiztion technology is not in official
document.
...
int main() {
    ...
    hipLaunchKernelGGL(
        null_kernel, dim3(1, 1),
        dim3(THREADS_PER_BLOCK_X, THREADS_PER_BLOCK_Y, THREADS_PER_BLOCK_Z), 0,
        0, deviceA);

    hipEventRecord(start, NULL);

    hipLaunchKernelGGL(
        null_kernel, dim3(TOTAL_THREADS / THREADS_PER_BLOCK_X, 1),
        dim3(THREADS_PER_BLOCK_X, THREADS_PER_BLOCK_Y, THREADS_PER_BLOCK_Z), 0,
        0, deviceA);
